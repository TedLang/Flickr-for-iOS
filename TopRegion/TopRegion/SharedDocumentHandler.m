...
//The project is finished by adapting the knowledge form Stanford CS193p 2013 fall, i also adapting certain code form 
...
- (UIManagedDocument *)document
{
    if (!_document) {
        ...
        url = [url URLByAppendingPathComponent:@"TopRegion"];
